...
//#region Funcionamiento general del posicionamiento
	...
	function detectNearBox(event){
		...
		for(var i = 0; i < objects.length; i++){
			...
			//Declaración de los margenes X
			leftExtMargin = boxLeft[i] - 5;
			leftIntMargin = boxLeft[i] + 5;
			rightIntMargin = boxRight[i] - 5;
			rightExtMargin = boxRight[i] + 5;

			//Declaración de los margenes Y
			upExtMargin = boxTop[i] + 5;
			upIntMargin = boxTop[i] - 5;
			downIntMargin = boxBottom[i] + 5;
			downExtMargin = boxBottom[i] - 5;

			//Declaración de los margenes X
			leftPalletExtMargin = - palletLenght / 2 - 5;
			leftPalletIntMargin = - palletLenght / 2 + 5;
			rightPalletIntMargin = palletLenght / 2 - 5;
			rightPalletExtMargin = palletLenght / 2 + 5;

			//Declaración de los margenes Y
			upPalletExtMargin = palletWidth / 2 + 5;
			upPalletIntMargin = palletWidth / 2 - 5;
			downPalletIntMargin = - palletWidth / 2 + 5;
			downPalletExtMargin = - palletWidth / 2 - 5;
